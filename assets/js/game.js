    ...
    for (var i = 0; i < enemyNames.length; i++) {
        ...
        if (playerHealth > 0) {
            ...
            if (playerHealth > 0 && i < enemyNames.length - 1) {
                // ask if player wants to ue the store before next round
...
var endGame = function() {
    // if player s still alive, player wins!
    if (playerHealth > 0) {
        window.alert("Great job, you've survived the game! You now have a socre of " + playerMoney + ".");
    }
    else {
...
var shop = function() {
    ...
    switch (shopOptionPrompt) {
        ...
        case "refill":
            if (playerMoney >= 7) {
                window.alert("Refilling playr's health by 20 for 7 dollars.");
